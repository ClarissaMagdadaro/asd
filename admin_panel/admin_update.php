    ...
    <div class="main-container">
        ...
        <section class="form-container">
            ...
            <form action="" method="post" enctype="multipart/form-data" class="register">
                <div class="img-box">
                    <img src="../uploaded_files/<?= $fetch_admin['image']; ?>" alt="Profile Image">
                </div>
                ...
                <div class="flex">
                    <div class="col">
                        <div class="input-field">
                            ...
                            <input type="text" name="name" placeholder="<?= $fetch_admin['name']; ?>" class="box">
                        </div>
                        <div class="input-field">
                            <p>Your Email <span>*</span> </p>
                            <input type="email" name="email" placeholder="<?= $fetch_admin['email']; ?>" class="box">
                        </div>
                        <div class="input-field">
